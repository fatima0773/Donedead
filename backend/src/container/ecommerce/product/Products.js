    ...
    <>
      ...
      <Main>
        <Row gutter={30}>
          ...
          <Col className="product-content-col" xxl={30} lg={30} md={30} xs={30}>
            <TopToolBox>
              <Row gutter={0}>
                ...
                <Col xxl={10} xs={24}>
                  <div className="product-list-action d-flex justify-content-between align-items-center">
                    <div className="product-list-action__tab">
                      <span className="toolbox-menu-title"> Category:</span>
                      <Radio.Group onChange={onSorting} defaultValue="rate">
                        <Radio.Button value="rate">DUNK</Radio.Button>
                        <Radio.Button value="popular">YEEZY</Radio.Button>
                        <Radio.Button value="time">JORDAN</Radio.Button>
                      </Radio.Group>
                    </div>
